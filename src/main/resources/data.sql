...
-- MESSAGES
insert into message (id, message_type_id, channel_id, notifier_user_id, body) values (1, 1, 1, 1, 'Finance message body 1');
insert into message (id, message_type_id, channel_id, notifier_user_id, body) values (2, 1, 1, 2, 'Finance message body 2');
insert into message (id, message_type_id, channel_id, notifier_user_id, body) values (3, 1, 2, 1, 'Sports message body 1');
insert into message (id, message_type_id, channel_id, notifier_user_id, body) values (4, 1, 2, 2, 'Sports message body 2');
